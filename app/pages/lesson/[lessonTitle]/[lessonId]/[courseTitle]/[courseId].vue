...
const copToUsd = (cop, rate) => cop / rate;
</script>
...
<!-- HERO SECTION (Diseño 2 columnas como la imagen) -->
    ...
    >
        ...
        <span class="font-weight-bold text-white text-shadow">
            ...
            <!-- BARRA DE CONTROL -->
            <v-card class="bg-dark-card pa-4 rounded-lg mb-4" flat>
              ...
              <div v-if="currentLesson?.type === 'video'">
                ...
                <p class="text-grey-lighten-1 mb-4" style="line-height: 1.6;">
                  {{ currentLesson?.description || 'No hay descripción disponible para esta lección.' }}
                </p>
                
                <v-btn color="secondary" variant="flat" size="small" class="text-capitalize mt-2">
              ...
              <div v-else class="markdown-content">
                <!-- Simulación de contenido Markdown -->
                <h2 class="text-h6 text-primary mb-4">Notas de lectura</h2>
                <p class="text-grey-lighten-1">
                  En JavaScript moderno, preferimos usar <code>const</code> por defecto y <code>let</code> solo cuando sabemos que el valor cambiará.
                  <br><br>
                  El uso de <code>var</code> está desaconsejado en ES6+.
                </p>
              </div>
            ...
            <v-card class="bg-dark-sidebar rounded-lg elevation-4 sticky-sidebar mt-12" style="min-height: 795px;" flat>
              ...
              <div class="pa-4 border-b border-opacity-10">
                ...
                <div class="d-flex justify-space-between mt-1">
                  <span class="text-caption text-secondary font-weight-bold">{{ progress }}% completado</span>
              ...
              <div class="sidebar-content">
                ...
                >
                  <v-list-group
                    v-for="(module, i) in curso?.contenido"
                    :key="i"
                    :value="module.title"
                  >
                    ...
                    <template v-slot:activator="{ props }">
                      <v-list-item
                        v-bind="props"
                        :title="module.title"
                        :subtitle="`${module.lessons.length} Lecciones`"
                        active-class="bg-dark-card"
                        class="module-header"
                      >
...
.active-lesson {
  background-color: #1a2024 !important;
  border-left: 3px solid #00B894 !important; /* Primary Color */
}
